const caseFleetData = [
    {
        ...
        price: "$850,000",
        desc: "Флагман агроіндустрії та переможець Tractor of the Year 2025. Оснащений 16-літровим двигуном FPT Cursor 16 з двоступеневим турбонаддувом."
    },
    {
        id: "magnum-400",
        ...
        img: "magnum_400.jpg",
        price: "$450,000",
        desc: "Еталон продуктивності серед важких колісних тракторів. Трансмісія CVXDrive забезпечує безступеневе прискорення від 0 до 50 км/год."
    },
    {
        id: "optum-440",
        ...
        img: "optum_440.jpg",
        price: "$320,000",
        desc: "Універсальний атлет, розроблений для робіт, що вимагають високої потужності та маневреності. Система AFS Connect дає повну прозорість."
    },
    {
        id: "puma-260",
        ...
        img: "puma_260.jpg",
        price: "$240,000",
        desc: "Найпотужніша та найтихіша Puma в історії лінійки. Інноваційна кабіна з рівнем шуму лише 66 дБ забезпечує умови роботи преміум-класу."
    },
    {
        id: "axial-8250",
        ...
        img: "quadtrac_715.jpg",
        price: "$650,000",
        desc: "Високопродуктивний роторний комбайн. Технологія Harvest Command™ автоматично коригує налаштування залежно від умов врожаю."
    },
    {
        id: "farmall-120c",
        name: "Farmall 120C",
        ...
        img: "puma_260.jpg",
        price: "$95,000",
        desc: "Компактний та надійний помічник для тваринницьких ферм. Економічний двигун F5 Stage V гарантує низькі експлуатаційні витрати."
    }
];
    ...
    data.forEach((machine, index) => {
        ...
        card.innerHTML = `
            <div class="machine-header">
                ...
                <span class="machine-price" style="font-weight: 900; color: #fff;">${machine.price}</span>
            </div>
            <div class="machine-img" style="height: 200px; margin: 15px 0; display:flex; align-items:center; justify-content:center;">
            ...
            <p class="machine-desc" style="font-size: 0.8rem; line-height: 1.4; color: var(--text-secondary); margin-bottom: 15px; height: 3.2em; overflow: hidden;">${machine.desc}</p>
            <button class="buy-btn" onclick="openOrderModal('${machine.name}')">КУПИТИ ЗАРАЗ</button>
        `;
